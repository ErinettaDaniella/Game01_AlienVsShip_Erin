...
#		self.my_stats = myStats(self)
	...
	#def check_bullet_creeper_collisons(self):
		collisions = pygame.sprite.groupcollide(self.bullets, self.creeper_army, True, True)
		#collisions = pygame.sprite.groupcollide(self.creeper_army, self.bullets, False, True)
		#for hitcreeper in collisions:
		#	print(creeper.life)
		#	hitcreeper.life -= 1
		#	if hitcreeper.life == 0:
		#		self.creeper_army.remove(hitcreeper)


		if len(self.creeper_army) == 0:
			#self.bullets.empty()
			self.create_creeper_army()
